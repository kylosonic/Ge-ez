            ...
            <div key={product.id} className="group relative">
              <div className="aspect-square w-full overflow-hidden rounded-xl bg-stone-200 group-hover:opacity-90 transition-opacity relative">
                ...
                <button 
                  ...
                  className="absolute bottom-4 right-4 h-10 w-10 bg-white rounded-full flex items-center justify-center shadow-lg hover:bg-black hover:text-white transition-all transform translate-y-2 opacity-0 group-hover:opacity-100 group-hover:translate-y-0 duration-300 z-10"
                >
                    <Plus size={20} />
                </button>
              </div>
              <div className="mt-4 flex justify-between">
                <div>
                  <h3 className="text-lg font-medium text-stone-900">
                    {/* Removed anchor tag to prevent navigation since we have no detailed view */}
