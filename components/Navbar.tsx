          ...
          <div className="hidden md:flex items-center space-x-8">
            {NAV_CATEGORIES.map((item) => (
              <button
                ...
                className={`text-sm font-medium transition-colors ${activeCategory === item ? 'text-stone-900 font-bold underline decoration-2 underline-offset-4' : 'text-stone-600 hover:text-black'
                  }`}
              >
                {item}
              </button>
          ...
          <div className="space-y-1 px-4 pb-3 pt-2">
            {NAV_CATEGORIES.map((item) => (
              <button
                ...
                className={`block w-full text-left py-2 px-3 text-base font-medium rounded-md ${activeCategory === item ? 'bg-stone-100 text-stone-900' : 'text-stone-600 hover:bg-stone-50 hover:text-stone-900'
                  }`}
              >
                {item}
              </button>
